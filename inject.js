//chrome.extension.sendMessage({},function(){var readyStateCheckInterval=setInterval(function(){if("complete"===document.readyState){clearInterval(readyStateCheckInterval);
